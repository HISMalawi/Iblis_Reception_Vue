...
export default defineComponent({
  ...
  props: ['orders', 'Results', 'Statuses', 'tests', 'users', 'labSections', 'accepted_by'],
    setup(props, context){
    ...
    return { closePatientResultReport, orders, results, statuses,users, labSections, accepted_by }
  }
});
</script>
